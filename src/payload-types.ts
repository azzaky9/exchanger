...
export interface Config {
  ...
  jobs: {
    tasks: {
      disableExchangeRate: TaskDisableExchangeRate;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface FiatToCrypto {
  ...
  networkSymbolDetail?: string | null;
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'disableExchangeRate';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'disableExchangeRate') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskDisableExchangeRate".
 */
export interface TaskDisableExchangeRate {
  input?: unknown;
  output?: unknown;
}
/**
